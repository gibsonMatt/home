...
export const portfolio_data: PortfolioItem[] = [
  ...
  },
  {
    ...
    description:
      "Hemiplasy Inference Simulation Tool: a Python CLI for estimating the probability of hemiplasy in a phylogenentic species tree with branch lengths and categorical traits",
  },
  {
    name: "stacks-pairwise",
    link: "https://github.com/gibsonMatt/stacks-pairwise",
    description:
      "A utility for accurately calculating pairwise divergence between samples across RAD tags in STACKS output",
  },
  {
    name: "mvnselection",
    link: "https://gibsonmatt.shinyapps.io/mvnselection/",
    description:
      "R Shiny app for simulating allele frequency divergence using a multivariate normal",
  },
  {
    name: "prettymap",
